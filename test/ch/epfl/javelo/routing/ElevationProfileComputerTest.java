...
class ElevationProfileComputerTest {
    ...
    void elevationProfileOnNanInMiddle2() {
        ...
        DoubleUnaryOperator profile = Functions.sampled(type3Array, 9);
        ...
        DoubleUnaryOperator profile2 = Functions.sampled(type3Array, 9);

        Edge edge1 = new Edge(0, 3, fromPoint, toPoint, 9, profile);
        Edge edge2 = new Edge(0, 3, fromPoint, toPoint, 9, profile2);
