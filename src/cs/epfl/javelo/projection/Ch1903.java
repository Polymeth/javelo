...
public final class Ch1903 {
    ...
    public static double n(double lon, double lat) {
        ...
        return 1200147.07 + 308807.95*phi1 + 3745.23*Math.pow(lambda1, 2) + 76.63*Math.pow(phi1, 2) - 194.56*Math.pow(lambda1, 2)*phi1 + 119.79*Math.pow(phi1, 3);
    }
    ...
    public static double lon(double e, double n) {
        ...
        // division comme ça ou grace à une méthode ?
        return Math.toRadians(lambda0 * Math2.ceilDiv(100, 36));
    }
    ...
    public static double lat(double e, double n) {
        ...
        // division comme ça ou grace à une méthode ?
        return Math.toRadians(phi0 * Math2.ceilDiv(100, 36));
    }
}
